...
This repository contains the code, experiments, and documentation developed during the Google Summer of Code 2026 for the **Physics Guided Machine Learning on Real Lensing Images** project, under the Machine Learning for Science (ML4SCI) organization.
...
* [Link to the notebook](/notebooks/Exploratory Analysis and Assessment of Spatial Separability in Dark Matter Substructure Dataset.ipynb)
...
The empirical evaluations and model training pipelines documented in this repository rely on the dataset shared by **ML4SCI**. The complete dataset can be accessed and downloaded via the following link:
